...
/**
 * Portions of the service specification ({@tutorial service-spec}) are inserted into the TXT record of an
...
/**
 * The service specification ({@tutorial service-spec}) derived from the service record ({@tutorial service-record}).
 * @type {object}
 */
ServiceRecord.prototype.spec = {};

/**
 * The {@link EdisonMDNS} module suggests the best addresses to reach the service at. suggestedAddresses[0]
 * contains the module's best suggestion followed by the second best and so on
 * ({@link EdisonMDNS.serviceAddressFilter}).
 * @type {Array}
 */
...
/**
 * Get a service specification ({@tutorial service-spec}) derived from this service record. The specification
 * contains the {@link EdisonMDNS} module's suggested address to reach the service at (see {@tutorial service-record}).
 * @returns {Object}
 */
...
/**
 * Initialize this service record ({@tutorial service-record}) from a service specification ({@tutorial service-spec})
 */
