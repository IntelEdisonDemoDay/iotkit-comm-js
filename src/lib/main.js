 ...
 * @type {object} see {@link lib/config.json}, {@link module:config-manager}
 */
 ...
 * @param serviceSpec {object} JSON service spec object ({@tutorial service-spec})
 ...
 * look for ({@tutorial service-query})
...
/**
 * Connect to a service completely described by the serviceSpec. Unlike {@link main.exports.createClient},
 * a search for service on the LAN is not performed.
 * @param serviceSpec {object} {@tutorial service-spec}
 ...
 * @param serviceSpec {@tutorial service-spec}
 */
