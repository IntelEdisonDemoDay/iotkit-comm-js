...
/**
* subscribe to data published by either your own devices or sensors on the same device
*/
EnableIoTCloudClient.prototype.subscribe = function (deviceId) {
    if(typeof deviceId === 'undefined') {
        // subscribe to the data on the same device
        this.client.subscribe(EnableIoTCloudClient.prototype.topic);
    } else {
        // subscribe to other device under my user id
 ...
 * @param topic
 */
EnableIoTCloudClient.prototype.unsubscribe = function (deviceId) {
    if(typeof deviceId === 'undefined') {
        // subscribe to the data on the same device
        this.client.unsubscribe(EnableIoTCloudClient.prototype.topic);
    } else {
        // subscribe to other device under my user id
        this.client.unsubscribe(deviceId);
    }
};
