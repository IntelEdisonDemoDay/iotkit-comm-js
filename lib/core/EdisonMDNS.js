 ...
 * @constructor module:serviceDiscovery~EdisonMDNS
 */
function EdisonMDNS() {
...
EdisonMDNS.prototype.advertiseService = function (serviceSpec) {
  ...
  this.advertiser = mdns.createAdvertisement(serviceRecord.rawRecord.type, serviceRecord.rawRecord.port, options);
...
EdisonMDNS.prototype.discoverServices = function (serviceQuery, userServiceFilter, callback) {
  ...
  this.browser = mdns.createBrowser(rawServiceQuery.type, { resolverSequence: exports.mdnsResolverSequence });
...
module.exports = EdisonMDNS; // must be at the end
