...
/** the service query object provided by the user ({@tutorial service-spec-query})*/
 ...
 */
//todo: change to file as default param
...
/**
 * Read a service query json file and initialize this object ({@tutorial service-spec-query}).
...
/**
 * Read a service query string and initialize this object ({@tutorial service-spec-query}).
 ...
 * @function module:client~ServiceQuery.setup
 */
function setup() {
  "use strict";
  this.validate();
...
/**
 * Validate the service query object ({@tutorial service-spec-query}).
 */
